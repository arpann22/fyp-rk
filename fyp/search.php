  ...
  <div class="grid_3">
    ...
    <input id="btnRadio" type="button" value="Get Selected Value" />-->
          ...
          <div class="form_but1">
            ...
            <div class="col-sm-7 form_radios">
              <input type="checkbox" class="radio_1" name="maritalstatus" value="Single" <?php echo "checked" ?> />
              Single &nbsp;&nbsp;
          ...
          <div class="form_but1">
            <label class="col-sm-5 control-lable1" for="country">Cities : </label>
            <div class="col-sm-7 form_radios">
              <div class="select-block1">
                <select name="country">
                  <option value="">Cities</option>
                  <option value="Japan">Kathmandu</option>
                  <option value="Kenya">Bhaktapur</option>
                  <option value="Dubai">Lalitpur</option>
                  <option value="Italy">Chitwan</option>
                  <option value="Greece">Pokhara</option>
                  <option value="Iceland">Hetauda</option>
                  <option value="China">Butwal</option>
                  <option value="India">Biratnagar</option>
                  <option value="Irland">Dharan</option>
                  <option value="Srilanka">Nepalgunj</option>
                  <option value="Russia">Ithari</option>
                  <option value="Hong Kong">Dhangadi</option>
                  <option value="Germany">Birgunj</option>
                </select>
              </div>
            </div>
            <div class="clearfix"> </div>
            ...
            <div class="col-sm-7 form_radios">
              <div class="select-block1">
                <select name="state">
                  ...
                  <option value="Kerala">Koshi</option>
                  <option value="Tamilnadu">Bagmati</option>
                  <option value="Karnataka">Gandaki</option>
                  <option value="Madhyapradesh">Lumbini</option>
                </select>
              </div>
            </div>
            <div class="clearfix"> </div>
            ...
            <div class="col-sm-7 form_radios">
              <div class="select-block1">
                <select name="religion">
                  ...
                  <option value="Jain-All">Christian</option>
                  <option value="Jain-Digambar">Buddhist</option>
                  <option value="Jain-Others">Others</option>
            ...
            <div class="col-sm-7 form_radios">
              <div class="select-block1">
                <select name="mothertounge">
                  <option value="Malayalam">Nepali</option>
                  <option value="English">English</option>
                  <option value="French">Maithili</option>
                  <option value="Telugu">bhojpuri</option>
                  <option value="Bengali">Rai</option>
                  <option value="Bihari">Tamang</option>
                  <option value="Hindi">Limbu</option>
                </select>
              </div>
            </div>
            <div class="clearfix"> </div>
          ...
          <div class="form_but1">
            ...
            <div class="col-sm-7 form_radios">
              <div class="col-sm-5 input-group1">
                <input class="form-control has-dark-background" name="agemin" id="slider-name" placeholder="18"
                  type="text" required="" />
              </div>

              <div class="col-sm-5 input-group1">
                <input class="form-control has-dark-background" name="agemax" id="slider-name" placeholder="40"
                  type="text" required="" />
              </div>
              <div class="clearfix"> </div>
            </div>
