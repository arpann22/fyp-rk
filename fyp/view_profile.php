...
if ($result) {
	...
	$lname = is_null($row) ? '' : $row['lastname'];
	$sex = is_null($row) ? '' : $row['sex'];
	$email = is_null($row) ? '' : $row['email'];
	$dob = is_null($row) ? '' : $row['dateofbirth'];
	$religion = is_null($row) ? '' : $row['religion'];
	$caste = is_null($row) ? '' : $row['caste'];
	$subcaste = is_null($row) ? '' : $row['subcaste'];
	$country = is_null($row) ? '' : $row['country'];
	$state = is_null($row) ? '' : $row['state'];
	$district = is_null($row) ? '' : $row['district'];
	$age = is_null($row) ? '' : $row['age'];
	$maritalstatus = is_null($row) ? '' : $row['maritalstatus'];
	$profileby = is_null($row) ? '' : $row['profilecreatedby'];
	$education = is_null($row) ? '' : $row['education'];
	$edudescr = is_null($row) ? '' : $row['education_sub'];
	$bodytype = is_null($row) ? '' : $row['body_type'];
	$physicalstatus = is_null($row) ? '' : $row['physical_status'];
	$drink = is_null($row) ? '' : $row['drink'];
	$smoke = is_null($row) ? '' : $row['smoke'];
	$mothertounge = is_null($row) ? '' : $row['mothertounge'];
	$bloodgroup = is_null($row) ? '' : $row['blood_group'];
	$weight = is_null($row) ? '' : $row['weight'];
	$height = is_null($row) ? '' : $row['height'];
	$colour = is_null($row) ? '' : $row['colour'];
	$diet = is_null($row) ? '' : $row['diet'];
	$occupation = is_null($row) ? '' : $row['occupation'];
	$occupationdescr = is_null($row) ? '' : $row['occupation_descr'];
	$fatheroccupation = is_null($row) ? '' : $row['fathers_occupation'];
	$motheroccupation = is_null($row) ? '' : $row['mothers_occupation'];
	$income = is_null($row) ? '' : $row['annual_income'];
	$bros = is_null($row) ? '' : $row['no_bro'];
	$sis = is_null($row) ? '' : $row['no_sis'];
	$aboutme = is_null($row) ? '' : $row['aboutme'];
	...
	if ($result2) {
		...
		$pic1 = is_null($row2) ? '' : $row2['pic1'];
		$pic2 = is_null($row2) ? '' : $row2['pic2'];
		$pic3 = is_null($row2) ? '' : $row2['pic3'];
		$pic4 = is_null($row2) ? '' : $row2['pic4'];
	}
} else {
							...
							<table class="table_working_hours">
								<tbody>
									<tr class="opened_1">
										...
										<td class="day_value">
											<?php echo is_null($fname) ? '' : $fname . " " . is_null($lname) ? '' : $lname; ?>
										</td>
									</tr>
									<tr class="opened_1">
						...
						<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
							<ul id="myTab" class="nav nav-tabs nav-tabs1" role="tablist">
								...
								<li role="presentation"><a href="#profile1" role="tab" id="profile-tab1"
										data-toggle="tab" aria-controls="profile1">Partner Preference</a></li>
							</ul>
